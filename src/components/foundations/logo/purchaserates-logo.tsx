...
export const PurchaseRatesLogo = (props: ComponentPropsWithoutRef<"svg">) => {
    return (
        <svg viewBox="0 0 200 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            {/* Text */}
            <text x="38" y="26" fontSize="16" fontWeight="700" fill="#3B82F6" fontFamily="system-ui, -apple-system, sans-serif">
                Purchase
            </text>
            <text x="112" y="26" fontSize="16" fontWeight="700" fill="#16A34A" fontFamily="system-ui, -apple-system, sans-serif">
                Rates
            </text>
            <text x="157" y="26" fontSize="16" fontWeight="400" fill="currentColor" fontFamily="system-ui, -apple-system, sans-serif" opacity="0.6">
                .com
            </text>
        </svg>
    );
