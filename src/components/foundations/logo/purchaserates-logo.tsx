...
export const PurchaseRatesLogo = (props: ComponentPropsWithoutRef<"svg">) => {
    return (
        <svg viewBox="0 0 220 40" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <text x="120" y="26" fontSize="16" fontWeight="700" fill="#16A34A" fontFamily="system-ui, -apple-system, sans-serif">
                Rates
            </text>
            <text x="168" y="26" fontSize="16" fontWeight="400" fill="currentColor" fontFamily="system-ui, -apple-system, sans-serif" opacity="0.6">
                .com
            </text>
        </svg>
    );
